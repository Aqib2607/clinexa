...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'card': '0 2px 8px -2px rgba(49, 43, 30, 0.08), 0 4px 16px -4px rgba(49, 43, 30, 0.12)',
        'card-hover': '0 8px 24px -4px rgba(49, 43, 30, 0.12), 0 16px 32px -8px rgba(49, 43, 30, 0.16)',
        'nav': '0 1px 3px rgba(49, 43, 30, 0.08)',
      },
    },
  },
